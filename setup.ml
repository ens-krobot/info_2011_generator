...
(* OASIS_START *)
(* DO NOT EDIT (digest: c6c71a26c456b58aefa0d72b3f80d8da) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "http://sourceforge.net/projects/krobot/";
          synopsis = "krobot-generator";
          description =
            Some "Generate source code from a protocol description";
          categories = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "krobot-protocol"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "krobot_proto2c.ml"; 
                   })
            ];
          plugins =
